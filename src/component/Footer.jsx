...
function Footer() {
    return (
        <>
            <div data-scroll data-scroll-section data-scroll-speed="-.1" className='overflow-hidden h-[45vw] w-full bg-zinc-800 rounded-t-2xl flex font-Neue text-zinc-200'>
                <div className='lpart w-1/2 h-full  py-[2vw] px-[3vw] flex flex-col justify-between'>
                    <div className='font-Founder text-8xl leading-none tracking-tighter'><h1>EYE-</h1><h1>OPENING</h1></div>
                    <div className='logo'>
                ...
                <div className='rpart w-1/2 h-full py-[2vw] flex flex-col gap-10'>
                    <div className='font-Founder text-8xl tracking-tighter'><h1>PRESENTATIONS</h1></div>
                    <div className='text-lg'><ul><li>S:</li>
                        <li>Instagram</li>
                        <li>Behance</li>
                        <li>Facebook</li>
                        <li>Linkedin</li></ul>
                    </div>
                    <div className='text-lg flex justify-between pr-[2vw]'>
                        <div><ul><li>L:</li>
                            <li>202-1965 W 4th Ave<br />Vancouver, Canada</li>
                            <li>30 Chukarina St<br />Lviv, Ukraine</li>
                        </ul>
                        </div>
                        <div><ul><li>M:</li>
                            <li>Home</li>
                    ...
                    <div className='text-lg mt-[7vw]'><ul><li>E:</li>
                        <li>hello@ochi.design</li></ul>
                    </div>
                </div>
            </div>
        </>
